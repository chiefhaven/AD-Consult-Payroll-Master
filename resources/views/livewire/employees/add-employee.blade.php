                    ...
                    <p>Employment details</p>
                            ...
                            <div class="col-md-4">
                                <div class="row input-group form-group-lg">
                                    ...
                                    placeholder="Termination notice period" fgroup-class="col-md-8 pr-0" class="{{ $errors->has('form.termination_notice_period') ? 'is-invalid' : '' }}" id="termination_notice_period"  wire:model="form.termination_notice_period" autocomplete="false" required/>

                                    <x-adminlte-select name="termination_notice_period_type" label="Period type" wire:model="form.termination_notice_period_type" fgroup-class="col-md-4 pl-0" class="{{ $errors->has('form.termination_notice_period_type') ? 'is-invalid' : '' }}" data-placeholder="Select an option..." autocomplete="false">
                                        <option value="null" selected disabled>Please select an option...</option>
                                        @foreach ($terminationPeriodTypes as $terminationPeriodType)
                                            <option>{{$terminationPeriodType}}</option>
                                        @endforeach
            ...
            <div class="card mb-3 p-4">
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        placeholder="Basic pay" fgroup-class="col-md-4 pr-0" class="{{ $errors->has('form.basic_pay') ? 'is-invalid' : '' }}" id="basic_pay" wire:model="form.basic_pay" autocomplete="false" required/>

                        <x-adminlte-select name="pay_period" label="Pay period:"
                            fgroup-class="col-md-2 pl-0" class="{{ $errors->has('form.pay_period') ? 'is-invalid' : '' }}" wire:model="form.pay_period" autocomplete="false">
                            <option value="null" selected disabled>Please select an option...</option>
