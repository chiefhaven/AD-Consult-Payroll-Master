        ...
        <div class="card mb-3 p-4">
            <div class="box-body">
                ...
                <div class="row">
                        ...
                        id="surname" wire:model="surname" required/>
        ...
        <div class="card mb-3 p-4">
            <div class="box-body">
                ...
                <div class="row">
                        ...
                        id="employee_alt_number" wire:model="employee_alt_number"/>
                        ...
                        fgroup-class="col-md-3" id="id_number" wire:model="id_number" required/>

                        <x-adminlte-input-file name="id_proof" label="Upload ID proof" placeholder="Choose a file..."
                        fgroup-class="col-md-3" wire:model="id_proof" wire:model="id_proof"/>
                        ...
                        id="family_contact_name" wire:model="family_contact_name" required wire:model="family_contact_name"/>
                        ...
                        id="family_contact_number" wire:model="family_contact_number" wire:model="family_contact_number" required/>

                        <x-adminlte-input name="family_contact_alt_number" label="Family contact alt number:"
                        placeholder="Family contact alt number" fgroup-class="col-md-4"
                        id="family_contact_alt_number" wire:model="family_contact_alt_number" required/>
        ...
        <div class="card mb-3 p-4">
            <div class="box-body">
                <p>Employment details</p>
                        ...
                        fgroup-class="col-md-3" id="hiredate" wire:model="hiredate"/>
                        ...
                        id="probation_period" wire:model="probation_period" wire:model="probation_period" required/>

                        <div class="col-md-4">
                            <div class="row input-group form-group-lg">
                                <x-adminlte-input name="termination_notice_period" label="Notice period:"
                                placeholder="Termination notice period" fgroup-class="col-md-8" id="termination_notice_period"  wire:model="termination_notice_period" required/>
                        ...
                        id="start_date_contract" wire:model="contract_start_date" required/>
                        ...
                        id="contract_end_date" wire:model="contract_end_date" required/>
                        ...
                        id="designated_location_specific" wire:model="designated_location_specifics" required/>
        ...
        <div class="card mb-3 p-4">
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    placeholder="Basic pay" fgroup-class="col-md-4" id="basic_pay" wire:model="basic_pay" required/>
