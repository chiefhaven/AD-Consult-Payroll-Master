                        ...
                        <td class="text-center">
                            <div class="dropdown d-inline-block">
                                ...
                                <div class="dropdown-menu dropdown-menu-end p-0">
                                    <div class="p-2">
                                        <!-- View Payroll Link -->
                                        <button class="dropdown-item nav-main-link" @click="fetchProductDetails(holiday.id)">
                                        ...
                                        <form class="dropdown-item nav-main-link" method="POST" :action="'/delete-holiday/' + holiday.id">
                                            @csrf
                                            @method('DELETE')
                                            <i class="nav-main-link-icon fas fa-trash-alt"></i>
                                            <button class="btn delete-holiday-confirm" type="submit">Delete</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
